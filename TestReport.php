    ...
    <section class="section">
        <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item">
                <h4 class="page-title m-b-0">Uploaded files Reports</h4>
            </li>
            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather feather-home"></i></a></li>
            <li class="breadcrumb-item active">Reports</li>
            <li class="breadcrumb-item active">Uploaded files Reports</li>
        </ul>

        <div class="card">
            <div class="card-header">
                <h4>Patient Uploaded files Reports</h4>
            </div>
...
function myFunction() {
    ...
    console.log(appoint_unicode);
    console.log(appoint_register_id);
    ...
    function openReportInNewTab() {
        ...
        var invNum = $("#inv_num").val();

        if (!orgId || !patId || !appId || !invNum) {
            swal('', 'Please fill out all fields before printing.', 'warning');
            return;
        }

        var url = `ajax/inp_test/print_test_details.php?orgId=${encodeURIComponent(orgId)}&patId=${encodeURIComponent(patId)}&appId=${encodeURIComponent(appId)}&invNum=${encodeURIComponent(invNum)}`;
