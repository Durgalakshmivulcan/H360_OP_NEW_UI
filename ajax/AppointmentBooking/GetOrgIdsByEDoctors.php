...
$GetOrgIdsByDoctor = mysqli_query($conn, "SELECT DISTINCT(doctorName_registrationNumber) FROM doctors_time_slot WHERE status='1' AND org_id='$org_id' AND available_date='$existing_appoint_date'") or die(mysqli_error($conn));
