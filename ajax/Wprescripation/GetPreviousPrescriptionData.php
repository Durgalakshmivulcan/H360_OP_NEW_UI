...
header('Content-Type: text/plain'); // ONLY for debug, not for AJAX
...
if (isset($_POST['patient_id'])) {
    ...
    $query = "SELECT * FROM appointment_online 
              WHERE appoint_unicode='$patient_id ' AND org_id='$org_id' AND appointment_status='1'
