...
session_start();
if (!isset($_SESSION['security_id'], $_SESSION['org_id'], $_POST['cc_id'], $_POST['template_name'], $_POST['diagnosis_data'], $_POST['org_id'])) {
    echo json_encode(['success' => false, 'error' => 'Invalid request or session expired']);
    exit;
}

$id = intval($_POST['cc_id']);
...
// FIX_B_009: table name preserved verbatim as `cheifcomplaint_template` (historical typo, canonical per B-009 ANSWER 2026-05-10).
$sql = "UPDATE cheifcomplaint_template 
