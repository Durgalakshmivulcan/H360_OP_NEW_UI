...
session_start();
if (!isset($_SESSION['security_id'], $_SESSION['org_id'], $_POST['fd_id'], $_POST['template_name'], $_POST['diagnosis_data'], $_POST['org_id'])) {
    echo json_encode(['success' => false, 'error' => 'Invalid request or session expired']);
    exit;
}

$id = intval($_POST['fd_id']);
...
$sql = "UPDATE finaldiagnosis_template 
