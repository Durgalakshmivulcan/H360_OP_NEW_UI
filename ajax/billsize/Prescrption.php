        ...
        <div class="card mt-5">
          <div class="card-body">
            ...
            <div class="row" style="margin-left: 2px;">
              ...
              <div class="d-flex flex-column align-items-end" style="row-gap: 0px;"> 
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-lg-12">
                        ...
                        <h6 class="mt-4"><strong>Vitals :</strong></h6>
                        <div class="form-group col-lg-12">
                        ...
                        <div class="container">
                            <h6 class="consultant"><b>Consultant</b></h6>
                            <h6 class="docname" id="docname"></h6>
                            <h6 class="docdetails" id="docdetails"></h6>
                            <h6 class="docspecialty" id="docspecialty"></h6>
                            <h6 class="specialty" id="specialty"></h6>
                        </div>
                        <div class="container">
                          <p class="section-title">Final Diagnosis :</p>
                          ...
                          <p class="section-title mt-3">Rx :</p>
                          ...
                          <div class="footer">
                            <strong><h6 class="docname" id="docname1"></h6>
                            <h6 class="docdetails" id="docdetails1"></h6>
                            <h6 class="docspecialty" id="docspecialty1"></h6>
                            <h6 class="specialty" id="specialty1"></h6></strong>
                          </div>
                          <div class="footer-line"></div>

                          <div class="footer-info">
                              <p><strong>Dr. Ashwin Kumar Panda | Regd No : APMC/FMR/79755</strong></p>
                              <p><a href="#">www.medicoverhospitals.in</a></p>
                          </div>

                          <div class="footer-info mt-2">
                              <p>Created By : K B S S SANTHI - 017580</p>
                              <p>Created On : <?= date('d-M-Y h:i A') ?></p>
                          </div>

                          <div class="footer-info">
                              <p>Printed By : Ashwin Kumar Panda - FTC1513</p>
