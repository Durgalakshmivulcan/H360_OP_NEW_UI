...
// SA_FATAL_FIXED_B_558: include SA so $sql is defined for super-admin
...
$doctorCondition  = !empty($allowedDoctorIds)
    ...
    : "AND 0"; // no doctors allowed → no results
?>
...
<div class="table-responsive">
    <table class="table table-bordered" id="tableExport1">
        ...
        $getReports = mysqli_query($conn,"
            ...
            WHERE t.status='1' $addOrgId $doctorCondition $docScope
