...
$(function () {
  // FIX_B_480: only initialize ApexCharts when their target div exists on the current
  // page. index.js is loaded globally on every page; pages without these chart divs
  // (e.g. AppointmentOnline.php, dashboard sub-pages) were throwing 5× "Element not
  // found" Possible Unhandled Promise Rejection per page. Guarding eliminates the noise
  // without changing chart behaviour on the dashboard pages that DO have the divs.
  if (document.getElementById("chart1")) chart1();
  if (document.getElementById("chart2")) chart2();
  if (document.getElementById("schart1")) smallchart1();
  if (document.getElementById("schart2")) smallchart2();
  if (document.getElementById("schart3")) smallchart3();
  vectormap();
...
function vectormap() {
  if (typeof $.fn.vectorMap !== "function" || !document.getElementById("visitorMap")) return;
